...
import groundImage from './img/platform.png';
import starImage from './img/star.png';
import dudeSprite from './img/dude.png';
...
class Game extends Phaser.Game {
  constructor() {
    ...
    super(width, height, Phaser.AUTO, 'app', {preload: preload, create: create, update: update});
    ...
    function preload() {
      ...
      game.load.spritesheet('dude', dudeSprite, 32, 48);
    }
    ...
    function update() {
      ...
      console.log(hitPlatform, 'hitting?');
